...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  <img src="./images/vcc.png" alt="Project 1 Image" style="height: auto; width: 300px; border-radius: 15px;">
  <div>
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  <img src="./images/vtcd.png" alt="Project 2 Image" style="height: auto; width: 300px; border-radius: 15px;">
  <div>
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  <img src="./images/staticdynamic.png" alt="Project 3 Image" style="height: auto; width: 300px; border-radius: 15px;">
  <div>
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  <img src="./images/pooling.png" alt="Project 4 Image" style="height: auto; width: 300px; border-radius: 15px;">
  <div>
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  <img src="./images/shape2.png" alt="Project 5 Image" style="height: auto; width: 300px; border-radius: 15px;">
  <div>
...
<div style="display: flex; align-items: center; gap: 15px; margin-bottom: 20px;">
  <img src="./images/feature.png" alt="Project 6 Image" style="height: auto; width: 300px; border-radius: 15px;">
  <div>
